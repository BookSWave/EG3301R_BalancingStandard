...
void leg_kinematic_task(void *argument) {
    ...
    while (1) {
        ...
        /////////
//        leg_pos(g_can_motors[8].angle_rad,g_can_motors[9].angle_rad,left_leg_pos);
//        leftLegPos.length = left_leg_pos[0];
//        leftLegPos.angle = left_leg_pos[1];
//        leg_pos(g_can_motors[17].angle_rad,g_can_motors[16].angle_rad,right_leg_pos);
...
//        left_F_control = -PID_Compute(&left_F, 0.17, leftLegPos.length, dt);
//        left_Tp_control = -PID_Compute(&left_Tp, 0, leftLegPos.angle, dt);
//        right_F_control = PID_Compute(&right_F, 0.17, rightLegPos.length, dt);
//        right_Tp_control = -PID_Compute(&right_Tp, 0, rightLegPos.angle, dt);
//        leg_conv(left_F_control,left_Tp_control,g_can_motors[8].angle_rad,g_can_motors[9].angle_rad,leftTorque);
//        leg_conv(right_F_control,right_Tp_control,g_can_motors[17].angle_rad,g_can_motors[16].angle_rad,rightTorque);
//        g_can_motors[8].torque = leftTorque[0];
//        g_can_motors[9].torque = leftTorque[1];
//        g_can_motors[16].torque = rightTorque[0];
//        g_can_motors[17].torque = rightTorque[1];
        ///////////////////
